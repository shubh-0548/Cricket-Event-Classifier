...
# Load the LRCN model
cmodel = tf.keras.models.load_model('/Users/MaxNewton/Desktop/new2/LRCN_model___Date_Time_2024_02_19__05_36_49___Loss_1.329925298690796___Accuracy_0.5555555820465088.h5')
fv_model = tf.keras.models.load_model('/Users/MaxNewton/Desktop/new2/fv_classification_model.h5')
...
def extract_clip(input_video, output_video, start_frame, end_frame):
    ...
    # Close the video clip object
    video_clip.close()
    copy_video(output_video, '/Users/MaxNewton/Desktop/new2/backend/output')
            ...
            if in_front_view_sequence:
                ...
                if len(current_clipping) >= min_frames_threshold:
                    ...
                    if len(first_frame_numbers) >= 2:
                        ...
                        out_path = f'/Users/MaxNewton/Desktop/new2/backend/{pred}/mini_{clipping_count}.mp4'
                        extract_clip(video_path, out_path, first_frame_numbers[-2], first_frame_numbers[-1])
